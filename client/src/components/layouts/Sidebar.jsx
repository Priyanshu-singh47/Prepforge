...
function Sidebar({ sidebarOpen, setSidebarOpen }) {
  ...
  return (
    <>
      ...
      <aside
        className={`fixed left-0 top-0 z-40 flex h-screen w-64 flex-col border-r border-gray-200 bg-white transition-transform duration-300 dark:border-gray-700 dark:bg-gray-900
      ...
      >
        ...
        <div className="flex h-16 items-center justify-between border-b border-gray-200 px-6 dark:border-gray-700">
          <div>
            ...
            <p className="text-sm text-gray-500">Prepare. Practice. Progress.</p>
          </div>
        ...
        <div className="border-t border-gray-200 p-4 dark:border-gray-700">
          ...
          >
            <FiLogOut size={21} className="transition-transform duration-300 group-hover:scale-110" />
