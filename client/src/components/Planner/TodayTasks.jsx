...
<h2 className="mb-4 text-base sm:text-lg font-semibold text-gray-900 dark:text-white">
Today's Tasks
</h2>
...
<p className="flex h-40 sm:h-56 items-center justify-center text-sm text-gray-500">
