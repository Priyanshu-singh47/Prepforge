  ...
  return (
    <div className="rounded-xl border border-gray-200 bg-white p-4 shadow-sm transition-all duration-300 hover:shadow-md dark:border-gray-700 dark:bg-gray-800">
      ...
      <div className="grid grid-cols-2 gap-2">
        ...
        {statCards.map((item) => {
          ...
          return (
            <div
              key={item.title}
              className="group flex items-center gap-3 rounded-lg border border-gray-100 p-3 transition-all duration-300 hover:-translate-y-0.5 hover:border-blue-200 hover:shadow-md dark:border-gray-700 dark:hover:border-blue-500"
            >
      ...
      <button
        ...
        className="group flex w-full items-center justify-start gap-2 rounded-lg px-2 py-2 text-sm font-medium text-blue-600 transition hover:bg-blue-50 dark:hover:bg-blue-900/20"
      >
