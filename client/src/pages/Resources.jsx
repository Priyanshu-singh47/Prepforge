  ...
  return(
    <div className="space-y-8">
      ...
      <Link
        ...
        className="inline-flex items-center gap-2 text-sm font-medium text-gray-500 hover:text-blue-600 dark:text-gray-400"
      >
        <ArrowLeft size={18}/>
        Back to Topics
      </Link>
          ...
          <div key={section.key}>
            ...
            <div className="grid gap-5 md:grid-cols-2 xl:grid-cols-3">
              ...
              {data.map((resource)=>(
                ...
                <div
                  key={resource._id}
                  className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm transition hover:-translate-y-1 hover:shadow-lg dark:border-gray-700 dark:bg-gray-800"
                >
